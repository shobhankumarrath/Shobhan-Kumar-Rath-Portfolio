...
const ContactMe = () => {
    ...
    return (
        <div id="contactme" className="pt-90 bg-gray-800 min-h-screen flex flex-col items-center px-4">
            <div className="bg-gray-900 text-white p-6 md:p-8 rounded-lg shadow-lg w-full max-w-md mt-12 md:mt-20 transition-all duration-300 hover:bg-gray-700 hover:shadow-2xl hover:scale-105">
